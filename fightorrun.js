...
var intro = function () {
    ...
    var loadgame = prompt('Do you want to load a previous game? Yes or no? Or type stop to close the game!');
    if (loadgame === 'yes') {
        load();
    }
    if (loadgame === 'stop') {
...
function start() {
    if (level === 1) {
        var startt = prompt('Do you fight? (type yes)(or type save to save your game)(or type load to load your game)');
        if (startt === 'yes') {
